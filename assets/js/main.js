(function ($) {
    ...
    $(document).ready(function () {
        ...
        =       Testimonial Slider
        =============================================*/
        /* INIT MOVED TO index.php inline script — see the <script> block
         * right after the testimonial section HTML. This avoids the
         * dual-init race condition that was causing the layout to break. */
