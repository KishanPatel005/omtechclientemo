...
!function (e, t) {
  ...
  w.ajaxSetup({
    ...
    return s > -1 && (r = vt(e.slice(s)), e = e.slice(0, s)), g(t) ? (n = t, t = void 0) : t && "object" == _typeof(t) && (i = "POST"), a.length > 0 && w.ajax({
      ...
      o = arguments, a.php(r ? w("<div>").append(w.parseHTML(e)).find(r) : e);
...
!function (e, t) {
  ...
  function xe(e, t, n, r, i) {
    for (var o, a, s, u, l, c, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++) if ((o = e[d]) || 0 === o) if ("object" === w(o)) S.merge(p, o.nodeType ? [o] : o);else if (me.test(o)) {
      a = a || f.appendChild(t.createElement("div")), s = (de.exec(o) || ["", ""])[1].toLowerCase(), u = ge[s] || ge._default, a.innerHTML = u[1] + S.phpPrefilter(o) + u[2], c = u[0];
      while (c--) a = a.lastChild;
  ...
  S.ajaxSetup({
    ...
    return -1 < s && (r = vt(e.slice(s)), e = e.slice(0, s)), m(t) ? (n = t, t = void 0) : t && "object" == _typeof(t) && (i = "POST"), 0 < a.length && S.ajax({
      ...
      o = arguments, a.php(r ? S("<div>").append(S.parseHTML(e)).find(r) : e);
    }).always(n && function (e, t) {
      a.each(function () {
        n.apply(this, o || [e.responseText, t, e]);
      });
...
window.Modernizr = function (a, b, c) {
  ...
  function K() {
    e.input = function (c) {
      ...
      return u.list && (u.list = !!b.createElement("datalist") && !!a.phpDataListElement), u;
